...
<header id="header">
    <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
        <p class="font-rale font-size-12 text-black-50 m-0">304, shree ram mobile store, jordan street, anand (91) 6355-904</p>
        <div class="font-rale font-size-14">
           <?php echo "Welcome...!! "; ?>
            <a href="logout.php" class="px-3 border-right border-left text-dark">Logout</a>
            <a href="cart1.php" class="px-3 border-right text-dark">Whishlist (0)</a>
        </div>
    </div>
...
<nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto font-rubik">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#banner-ads">Discount</a>
                </li>
                <li class="nav-item">
